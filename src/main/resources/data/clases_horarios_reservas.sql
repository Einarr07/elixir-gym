...
VALUES ('Dragon Fit', 'Clase para los amantes del deporte', 'PRINCIPIANTE', 50, 10),
...
VALUES ('2026-09-20', '08:00:00', '08:50:00', 1, 2), -- Dragon Fit con entrenador 2
       ('2026-09-20', '09:30:00', '10:15:00', 2, 3), -- Cardio Power con entrenador 3
       ('2026-09-20', '10:30:00', '11:30:00', 3, 2), -- Fuerza Total con entrenador 2
       ('2026-09-21', '07:00:00', '07:40:00', 4, 3), -- Yoga Flow con entrenador 3
...
VALUES ('2026-10-02', 'PENDIENTE', 1, 1),
       ('2026-10-03', 'CONFIRMADA', 2, 2),
       ('2026-10-04', 'CANCELADA', 3, 3),
       ('2026-10-05', 'PENDIENTE', 4, 4),
       ('2026-10-06', 'CONFIRMADA', 5, 5),
       ('2026-10-07', 'PENDIENTE', 6, 6),
       ('2026-10-08', 'CONFIRMADA', 7, 7),
       ('2026-10-09', 'CANCELADA', 8, 8),
       ('2026-10-10', 'PENDIENTE', 9, 9),
       ('2026-10-11', 'CONFIRMADA', 10, 10);
